...
`release.json` and `release.json.asc` are optional but useful. Current downloads are listed in [INSTALL.md](INSTALL.md) and on [amonite.org/downloads](https://amonite.org/downloads/).
